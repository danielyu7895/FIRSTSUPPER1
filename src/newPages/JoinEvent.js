                                ...
                                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                                    <form> {/*tab with all questions*/}
                                        ...
                                        <div className="text-center mt-12">
                                            ...
                                            <button ref="/modal" className="bg-purple-dark text-white active:bg-purple-dark font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
